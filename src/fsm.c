...
Project: C-CNC
Description: Finite State  Machine for the C-CNC constroller

Generated by gv_fsm ruby gem, see https://rubygems.org/gems/gv_fsm
gv_fsm version 0.3.2
Generation date: 2022-05-19 13:18:50 +0200
...
const char *ccnc_state_names[] = {"init", "idle", "load_block", "stop", "no_motion", "rapid_motion", "interp_motion"};
...
transition_func_t *const ccnc_transition_table[CCNC_NUM_STATES][CCNC_NUM_STATES] = {
  /* states:           init      , idle      , load_block, stop      , no_motion , rapid_motion, interp_motion */
  /* init          */ {NULL      , NULL      , NULL      , NULL      , NULL      , NULL      , NULL      }, 
  /* idle          */ {NULL      , NULL      , ccnc_reset, NULL      , NULL      , NULL      , NULL      }, 
...
// valid return states: CCNC_STATE_IDLE
